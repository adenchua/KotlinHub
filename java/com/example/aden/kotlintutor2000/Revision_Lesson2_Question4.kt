...
class Revision_Lesson2_Question4 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val title = "Arrays"
        val text = "Which of the following can create Array?"
        tv_revision2.text = text
        tv_revision2_title.text = title
        lesson2_button1.text = "Arrays()"
        lesson2_button2.text = "createArray()"
        lesson2_button3.text = "isArray()"
        lesson2_button4.text = "arrayOf()"
